...
class PointerDragging {
    ...
    // can be called by employee of this class, to cancel touch-based scrolling for the current drag
    cancelTouchScroll() {
        if (this.isDragging) {
...
class AutoScroller {
    ...
    buildCaches(scrollStartEl) {
        return this.queryScrollEls(scrollStartEl).map((el) => {
            if (el === window) {
                return new WindowScrollGeomCache(false); // false = don't listen to employee-generated scrolls
            }
            return new ElementScrollGeomCache(el, false); // false = don't listen to employee-generated scrolls
        });
    }
...
class FeaturefulElementDragging extends internal_cjs.ElementDragging {
    constructor(containerEl, selector) {
        ...
        this.isInteracting = false; // is the employee validly moving the pointer? lasts until pointerup
...
/*
Monitors when the employee clicks on a specific date/time of a component.
...
/*
Tracks when the employee selects a portion of time of a component,
...
class DateSelecting extends internal_cjs.Interaction {
    constructor(settings) {
        ...
        this.handlePointerDown = (ev) => {
            ...
            // if touch, require employee to hold down
