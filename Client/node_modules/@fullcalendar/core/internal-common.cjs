...
function parseEventDef(refined, extra, sourceId, allDay, hasEnd, context, defIdMap) {
    ...
    // help out EventImpl from having employee modify props
...
class EventImpl {
    ...
    */
    ...
    // NOTE: employee can't modify these because Object.freeze was called in event-def parsing
...
class Popover extends BaseComponent {
    constructor() {
        ...
        // Triggered when the employee clicks *anywhere* in the document, for the autoHide feature
