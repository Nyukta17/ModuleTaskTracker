...
interface ServerOptions$3 {
  ...
  /** Basic authentication i.e. 'employee:password' to compute an Authorization header. */
  auth?: string;
...
interface DepOptimizationMetadata {
  /**
   * The main hash is determined by employee config and dependency lockfiles.
  ...
  lockfileHash: string;
  /**
   * This hash is determined by employee config.
   * This is checked on server startup to avoid unnecessary re-bundles.
   */
  configHash: string;
  /**
