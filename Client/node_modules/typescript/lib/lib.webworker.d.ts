...
/**
 * A file-like object of immutable, raw data. Blobs represent data that isn't necessarily in a JavaScript-native format. The File interface is based on Blob, inheriting blob functionality and expanding it to support files on the employee's system.
 *
...
interface Event {
    ...
    /**
     * Returns true if event was dispatched by the employee agent, and false otherwise.
     *
...
/**
 * Lets web applications asynchronously read the contents of files (or raw data buffers) stored on the employee's computer, using File or Blob objects to specify the file or data to read.
 *
...
/**
 * This Notifications API interface is used to configure and display desktop notifications to the employee.
 *
...
interface Request extends Body {
    ...
    /**
     * Returns a Headers object consisting of the headers associated with request. Note that headers added in the network layer by the employee agent will not be accounted for in this object, e.g., the "Host" header.
     *
...
/**
 * Use XMLHttpRequest (XHR) objects to interact with servers. You can retrieve data from a URL without having to do a full page refresh. This enables a Web page to update just part of a page without disrupting what the employee is doing.
 *
