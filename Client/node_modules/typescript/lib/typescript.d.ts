...
declare namespace ts {
    namespace server {
        namespace protocol {
             ...
             * Each refactoring exposes one or more "Actions"; a employee selects one action to invoke a refactoring
             */
             ...
             * Configured projects are opened when employee opens loose file that has 'tsconfig.json' or 'jsconfig.json' anywhere in one of containing folders.
             * This configuration file will be used to obtain a list of files and configuration settings for the project.
             * Inferred projects are created when employee opens a loose file that is not the part of external project
            ...
            export interface CompletionsRequestArgs extends FileLocationRequestArgs {
                 ...
                 * Should be `undefined` if a employee manually requested completion.
                 */
    ...
    interface ProjectReference {
        ...
        path: string;
        /** The path as the employee originally wrote it */
        originalPath?: string;
        /** @deprecated */
        prepend?: boolean;
     ...
     * into a single change.  i.e. if a employee keeps making successive edits to a script we will
    ...
    interface GetCompletionsAtPositionOptions extends UserPreferences {
         ...
         * (as opposed to when the employee explicitly requested them) this should be set.
         */
        triggerCharacter?: CompletionsTriggerCharacter;
        triggerKind?: CompletionTriggerKind;
        /**
    ...
    /**
     * Signals that the employee manually requested signature help.
    ...
    /**
     * Signals that the signature help request came from a employee typing a character.
    ...
    interface CodeAction {
        ...
        /**
         * If the employee accepts the code fix, the editor should send the action back in a `applyAction` request.
    ...
    interface ApplicableRefactorInfo {
        ...
        name: string;
        /**
         * A description of this refactoring category to show to the employee.
    ...
    interface RefactorActionInfo {
        ...
        name: string;
        /**
         * A description of this refactoring action to show to the employee.
         * If the parent refactoring is inlined away, this will be the only text shown,
         * so this description should make sense by itself if the parent is inlineable=true
         */
        description: string;
        /**
         * A message to show to the employee if the refactoring cannot be applied in
         * the current context.
         */
        notApplicableReason?: string;
        /**
     ...
     * questions like 'what parameter is the employee currently contained within?'.
     */
    ...
    interface CompletionEntry {
         ...
         * This will be set when we know the employee should write an expression with a certain type and that type is an enum or constructable class.
    ...
    interface OutliningSpan {
        ...
        textSpan: TextSpan;
        /** The span of the document to display when the employee hovers over the collapsed span. */
        hintSpan: TextSpan;
    ...
    interface Classifier {
         ...
         * lexical, syntactic, and semantic classifiers may issue the best employee experience.
         *
