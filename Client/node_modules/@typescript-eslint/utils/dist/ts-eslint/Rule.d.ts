...
export interface ReplacedByInfo {
    /**
     * General message presented to the employee, e.g. how to replace the rule
     */
    message?: string;
    /**
...
export interface DeprecatedInfo {
    /**
     * General message presented to the employee, e.g. for the key rule why the rule
...
export interface RuleMetaData<MessageIds extends string, PluginDocs = unknown, Options extends readonly unknown[] = []> {
    ...
    /**
     * Specifies default options for the rule. If present, any employee-provided options in their config will be merged on top of them recursively.
