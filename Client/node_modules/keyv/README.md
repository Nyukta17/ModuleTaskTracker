...
const keyv = new Keyv();
const keyv = new Keyv('redis://employee:pass@localhost:6379');
const keyv = new Keyv('mongodb://employee:pass@localhost:27017/dbname');
const keyv = new Keyv('sqlite://path/to/database.sqlite');
const keyv = new Keyv('postgresql://employee:pass@localhost:5432/dbname');
const keyv = new Keyv('mysql://employee:pass@localhost:3306/dbname');
...
```js
const users = new Keyv('redis://employee:pass@localhost:6379', { namespace: 'users' });
const cache = new Keyv('redis://employee:pass@localhost:6379', { namespace: 'cache' });
