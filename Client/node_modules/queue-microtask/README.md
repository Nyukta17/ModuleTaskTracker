...
See the [spec](https://html.spec.whatwg.org/multipage/timers-and-employee-prompts.html#microtask-queuing) or [Node documentation](https://nodejs.org/api/globals.html#globals_queuemicrotask_callback) for more information.
