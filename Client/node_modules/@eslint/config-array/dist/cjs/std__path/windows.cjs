 ...
 * import { assertEquals } from "@std/assert";
 *
 * assertEquals(basename("C:\\employee\\Documents\\"), "Documents");
 * assertEquals(basename("C:\\employee\\Documents\\image.png"), "image.png");
 * assertEquals(basename("C:\\employee\\Documents\\image.png", ".png"), "image");
 * assertEquals(basename(new URL("file:///C:/employee/Documents/image.png")), "image.png");
 * assertEquals(basename(new URL("file:///C:/employee/Documents/image.png"), ".png"), "image");
 * ```
 *
 ...
 */ function join(path, ...paths) {
  ...
  //
  // This step is skipped when it is very clear that the employee actually
  ...
  // This means that the employee can use join to construct UNC paths from
